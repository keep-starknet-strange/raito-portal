...
const navigation = [
  { name: "Explorer", href: "/explorer", icon: Icons.cube, description: "Browse Bitcoin blocks" },
  { name: "Verify TX", href: "/tx-check", icon: Icons.search, description: "Check transaction inclusion" },
  { name: "Verify Block", href: "/block-check", icon: Icons.shield, description: "Verify block headers" },
  { name: "Developers", href: "/developers", icon: Icons.externalLink, description: "APIs and documentation" },
]
